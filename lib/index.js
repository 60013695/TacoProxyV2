...
module.exports = class {
    ...
    http(req, res, next = () => res.end('')) {
        ...
        if (typeof this.config.blacklist == 'object' && this.config.blacklist.length != 0) this.config.blacklist.forEach(blacklisted => proxyURL.hostname == blacklisted ? isBlocked = false : isBlocked = true);
